...
class DistribucionVolSemNXRelacion(models.Model):
    ...
    """
    cualidad = models.ForeignKey(DistribucionVolSemNXContenidoCualidad, on_delete=models.CASCADE)
    distribucion = models.ForeignKey(DistribucionVolSemNXContenidoDistribucion, on_delete=models.CASCADE)
